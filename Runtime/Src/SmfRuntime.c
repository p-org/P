...
static const SMF_TRIGGER g_SmfNullTrigger = { SmfNull, SmfNull };

static const PSMF_SMCONTEXT g_SmfNullSMMachinePointer = NULL;

const SMF_PACKED_VALUE g_SmfNullPayload = { SmfNullType, SmfNull }; // Todo: Hack - the first value must match up with the Null Type enum
