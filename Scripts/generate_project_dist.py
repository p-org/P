...
<Project DefaultTargets="Build" ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Condition="'$(Configuration)|$(Platform)'=='Debug|Win32'">
    ...
    <TargetName>StartOrNew</TargetName>
  </PropertyGroup>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|Win32'">
    <ClCompile>
      ...
      <PreprocessorDefinitions>WIN32;_DEBUG;_CONSOLE;DISTRIBUTED_RUNTIME;%(PreprocessorDefinitions)</PreprocessorDefinitions>
    ...
    <Link>
      ...
      <AdditionalDependencies>SMRuntime_User.lib;rpcrt4.lib;%(AdditionalDependencies)</AdditionalDependencies>
...
{{
    ...
    wchar_t* wc = (wchar_t *) malloc((cSize+1) * sizeof(wchar_t));
    mbstowcs_s(&returnValue, wc, cSize+1, c, cSize);
    return wc;
}}
...
{{
    ...
    wargs = (wchar_t **) malloc((argc - 2) * sizeof(wchar_t *));
    for (i = 2; i < argc; i++) {{
      wargs[i-2] = GetWC(argv[i]);
    }}
    ...
    if (strcmp(argv[1], "Start") == 0) {{
        ...
        StartMachine(MachineType_{MainMachine}, argc - 2, wargs);
    }} else if (strcmp(argv[1], "New") == 0) {{
	if (argc != 8) {{
	    return 1; // error code
	}}
        NewMachine(&DriverDecl_{name}, argc - 2, wargs);
    }} else {{
        return 1;
    }}
    return 0;
...
"""
    ...
    write(mainTmpl.format(name=name, Constructors=constructors, \
        ForeignFuns=foreignFuns, MainMachine=entryM),\
        tdir + "/" + name + ".c");
