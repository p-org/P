...
item lands. Historical sessions, decision rationale, and per-phase
planning live in [`ROADMAP.md`](ROADMAP.md), [`PLAN.md`](PLAN.md), and
the per-phase [`PLAN_P{0..4}.md`](.) documents.
...
| 4 — Spec machines                | ☐ | next; design in [`PLAN_P4.md`](PLAN_P4.md) |
...
work — see [`ROADMAP.md` § W3](ROADMAP.md) and [`PLAN_P4.md`](PLAN_P4.md).
...
| Document | Purpose |
|---|---|
| [`CLAUDE.md`](../CLAUDE.md)              | Build cookbook, conventions, surface keywords, style guide |
...
| [`PLAN_P{0..4}.md`](.)                   | Per-phase designs |
| [`PLAN_CEX.md`](PLAN_CEX.md)             | Counter-example rendering (v1 shipped; v1.5 / v2 follow-ups) |
