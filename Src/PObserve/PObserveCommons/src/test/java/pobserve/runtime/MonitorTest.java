...
import pobserve.runtime.exceptions.NonTotalStateMapException;
...
public class MonitorTest {
    ...
    class GotoStateWithPayloadsMonitorIncludingInitialEntryHandler extends Monitor {
        ...
        public List<Class<? extends PEvent<?>>> getEventTypes() {
            return List.of(CounterMonitor.AddEvent.class);
        }
    }
    ...
    class RaiseEventMonitor extends Monitor {
        ...
        public List<Class<? extends PEvent<?>>> getEventTypes() {
            return List.of(testEvent.class, noopEvent.class);
        }
