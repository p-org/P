package pobserve.runtime.testcases.clientserver;
...
public class PMachines {
    ...
    public static class BankBalanceIsAlwaysCorrect extends Monitor<BankBalanceIsAlwaysCorrect.PrtStates> {
        ...
        public HashMap<Long, Long> get_bankBalance() {
        ...
        public HashMap<Long, PTypes.PTuple_src_accnt_amnt_rId> get_pendingWithDraws() {
        ...
        public BankBalanceIsAlwaysCorrect() {
            super();
            addState(State.keyedOn(PrtStates.Init)
                    .isInitialState(true)
                    .withEvent(PEvents.eSpec_BankBalanceIsAlwaysCorrect_Init.class, p -> {
                        Anon(p);
                        gotoState(PrtStates.WaitForWithDrawReqAndResp);
                    }).build());
            addState(State.keyedOn(PrtStates.WaitForWithDrawReqAndResp)
        ...
        public void reInitializeMonitor() {
            registerState(State.keyedOn(PrtStates.Init)
                    .isInitialState(true)
                    .withEvent(PEvents.eSpec_BankBalanceIsAlwaysCorrect_Init.class, p -> {
                        Anon(p);
                        gotoState(PrtStates.WaitForWithDrawReqAndResp);
                    }).build());
            registerState(State.keyedOn(PrtStates.WaitForWithDrawReqAndResp)
                    .withEvent(PEvents.eWithDrawReq.class, this::Anon_1)
                    .withEvent(PEvents.eWithDrawResp.class, this::Anon_2)
                    .build());
        }
        ...
        private void Anon(HashMap<Long, Long> balance) {
            bankBalance = Clone.deepClone(balance);
        }
    ...
    public static class GuaranteedWithDrawProgress extends Monitor<GuaranteedWithDrawProgress.PrtStates> {
        ...
        public LinkedHashSet<Long> get_pendingWDReqs() {
            return this.pendingWDReqs;
        }
        ...
        public GuaranteedWithDrawProgress() {
            super();
            addState(State.keyedOn(PrtStates.NopendingRequests)
                    .isInitialState(true)
                    .withEvent(PEvents.eWithDrawReq.class, p -> {
                        Anon_3(p);
                        gotoState(PrtStates.PendingReqs);
                    }).build());
            addState(State.keyedOn(PrtStates.PendingReqs)
        ...
        public void reInitializeMonitor() {
            registerState(State.keyedOn(PrtStates.NopendingRequests)
                    .isInitialState(true)
                    .withEvent(PEvents.eWithDrawReq.class, p -> {
                        Anon_3(p);
                        gotoState(PrtStates.PendingReqs);
                    }).build());
            registerState(State.keyedOn(PrtStates.PendingReqs)
                    .withEvent(PEvents.eWithDrawResp.class, this::Anon_4)
                    .withEvent(PEvents.eWithDrawReq.class, p -> {
                        Anon_5(p);
                        gotoState(PrtStates.PendingReqs);
        ...
        private void Anon_4(PTypes.PTuple_stts_accnt_blnc_rId resp_1) throws TransitionException {
            ...
            TMP_tmp3_2 = Clone.deepClone(pendingWDReqs);
