...
public class PTypes {
    ...
    public static class PTuple_accnt_blnc implements PValue<PTuple_accnt_blnc> {
    ...
    public static class PTuple_accnt implements PValue<PTuple_accnt> {
        // (accountId:int)
        public long accountId;
    ...
    public static class PTuple_src_accnt_amnt_rId implements PValue<PTuple_src_accnt_amnt_rId> {
    ...
    public static class PTuple_stts_accnt_blnc_rId implements PValue<PTuple_stts_accnt_blnc_rId> {
    ...
    public static class PTuple_srvr_intlb implements PValue<PTuple_srvr_intlb> {
        ...
        public PTuple_srvr_intlb deepClone() {
            return new PTuple_srvr_intlb(server, Clone.deepClone(initialBalance));
        } // deepClone()
        ...
        public boolean deepEquals(PTuple_srvr_intlb other) {
            return (true
                    ...
                    && Equality.deepEquals(this.initialBalance, other.initialBalance)
            );
        } // deepEquals()
    ...
    public static class PTuple_serv_accnt_blnc implements PValue<PTuple_serv_accnt_blnc> {
