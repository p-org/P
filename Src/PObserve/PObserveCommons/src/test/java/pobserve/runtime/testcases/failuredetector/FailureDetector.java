package pobserve.runtime.testcases.failuredetector;
...
public class FailureDetector {
    ...
    public static class PTuple_fd_trial implements PValue<PTuple_fd_trial> {
        public long fd;
        public int trial;
    ...
    // (node:Node,trial:int)
    public static class PTuple_node_trial implements PValue<PTuple_node_trial> {
        public long node;
        public int trial;
    ...
    public static class PTuple_nmnds_nmcln implements PValue<PTuple_nmnds_nmcln> {
        public int numNodes;
    ...
    public static class ePing extends PEvent<PTuple_fd_trial> {
        public ePing(PTuple_fd_trial p) {
            this.payload = p;
        }
        private PTuple_fd_trial payload;
        public PTuple_fd_trial getPayload() {
            return payload;
        }
    ...
    public static class ePong extends PEvent<PTuple_node_trial> {
        public ePong(PTuple_node_trial p) {
            this.payload = p;
        }
        private PTuple_node_trial payload;
        public PTuple_node_trial getPayload() {
            return payload;
        }
    ...
    public static class eNotifyNodesDown extends PEvent<LinkedHashSet<Long>> {
        public eNotifyNodesDown(LinkedHashSet<Long> p) {
            this.payload = p;
        }
        private LinkedHashSet<Long> payload;
        public LinkedHashSet<Long> getPayload() {
            return payload;
        }
    ...
    public static class ReliableFailureDetector extends Monitor {
        ...
        public LinkedHashSet<Long> get_nodesShutdownAndNotDetected() {
            return this.nodesShutdownAndNotDetected;
        };

        private LinkedHashSet<Long> nodesDownDetected = new LinkedHashSet<Long>();
        public LinkedHashSet<Long> get_nodesDownDetected() {
            return this.nodesDownDetected;
        }
        ...
        private void Anon(LinkedHashSet<Long> nodes) {
            ...
            while ((true)) {
                ...
                TMP_tmp3 = SetIndexing.elementAt(nodes, i);
                nodesShutdownAndNotDetected.remove(TMP_tmp3);
                TMP_tmp4 = SetIndexing.elementAt(nodes, i);
        ...
        private void Anon_2(LinkedHashSet<Long> nodes_1)throws TransitionException {
            ...
            while ((true)) {
                ...
                TMP_tmp3_2 = SetIndexing.elementAt(nodes_1, i_1);
                nodesShutdownAndNotDetected.remove(TMP_tmp3_2);
                TMP_tmp4_1 = SetIndexing.elementAt(nodes_1, i_1);
        ...
        public ReliableFailureDetector() {
            super();
            addState(State.keyedOn(States.ALLSHUTDOWNNODESAREDETECTED_STATE)
                    .isInitialState(true)
                    .withEvent(eNotifyNodesDown.class, this::Anon)
                    .withEvent(eShutDown.class, this::Anon_1)
                    .build());
            addState(State.keyedOn(States.NODESSHUTDOWNBUTNOTDETECTED_STATE)
