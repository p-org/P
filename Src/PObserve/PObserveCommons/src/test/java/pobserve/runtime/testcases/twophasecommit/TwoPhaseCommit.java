package pobserve.runtime.testcases.twophasecommit;
...
import pobserve.runtime.exceptions.TransitionException;
import pobserve.runtime.values.Clone;
import pobserve.runtime.values.Equality;
import pobserve.runtime.values.PValue;
...
public class TwoPhaseCommit {
    ...
    public static class PTuple_key_val_trans implements PValue<PTuple_key_val_trans> {
        public String key;
        public int val;
        public int transId;
        ...
        public boolean deepEquals(PTuple_key_val_trans other) {
            return (true
                    && Equality.deepEquals(this.key, other.key)
                    && this.val == other.val
    ...
    public static class PTuple_clnt_trans implements PValue<PTuple_clnt_trans> {
        public long client;
        ...
        public boolean deepEquals(PTuple_clnt_trans other) {
            return (true
                    ...
                    && Equality.deepEquals(this.trans, other.trans)
            );
        } // deepEquals()
    ...
    public static class PTuple_trans_stts implements PValue<PTuple_trans_stts> {
        public int transId;
        public int status;
    ...
    public static class PTuple_clnt_key implements PValue<PTuple_clnt_key> {
        public long client;
        public String key;
    ...
    public static class PTuple_key_val_stts implements PValue<PTuple_key_val_stts> {
        public String key;
        public int val;
        public int status;
    ...
    public static class PTuple_prtcp_trans_stts implements PValue<PTuple_prtcp_trans_stts> {
    ...
    public static class PTuple_nmcln_nmprt_tpc_flprt implements PValue<PTuple_nmcln_nmprt_tpc_flprt> {
    ...
    public static class PTuple_nodes_nflrs implements PValue<PTuple_nodes_nflrs> {
        ...
        public PTuple_nodes_nflrs deepClone() {
            return new PTuple_nodes_nflrs((LinkedHashSet<Long>) Clone.deepClone(nodes), nFailures);
        } // deepClone()
        ...
        public boolean deepEquals(PTuple_nodes_nflrs other) {
            return (true
                    && Equality.deepEquals(this.nodes, other.nodes)
    ...
    public static class eWriteTransReq extends PEvent<PTuple_clnt_trans> {
        public eWriteTransReq(PTuple_clnt_trans p) {
            this.payload = p;
        }
        private PTuple_clnt_trans payload;
        public PTuple_clnt_trans getPayload() {
            return payload;
        }
    ...
    public static class eWriteTransResp extends PEvent<PTuple_trans_stts> {
        public eWriteTransResp(PTuple_trans_stts p) {
            this.payload = p;
        }
        private PTuple_trans_stts payload;
        public PTuple_trans_stts getPayload() {
            return payload;
        }
    ...
    public static class eReadTransReq extends PEvent<PTuple_clnt_key> {
        public eReadTransReq(PTuple_clnt_key p) {
            this.payload = p;
        }
        private PTuple_clnt_key payload;
        public PTuple_clnt_key getPayload() {
            return payload;
        }
    ...
    public static class eReadTransResp extends PEvent<PTuple_key_val_stts> {
        public eReadTransResp(PTuple_key_val_stts p) {
            this.payload = p;
        }
        private PTuple_key_val_stts payload;
        public PTuple_key_val_stts getPayload() {
            return payload;
        }
    ...
    public static class ePrepareReq extends PEvent<PTuple_key_val_trans> {
        public ePrepareReq(PTuple_key_val_trans p) {
            this.payload = p;
        }
        private PTuple_key_val_trans payload;
        public PTuple_key_val_trans getPayload() {
            return payload;
        }
    ...
    public static class ePrepareResp extends PEvent<PTuple_prtcp_trans_stts> {
        public ePrepareResp(PTuple_prtcp_trans_stts p) {
            this.payload = p;
        }
        private PTuple_prtcp_trans_stts payload;
        public PTuple_prtcp_trans_stts getPayload() {
            return payload;
        }
    ...
    public static class eCommitTrans extends PEvent<Integer> {
        public eCommitTrans(int p) {
            this.payload = p;
        }
    ...
    public static class eAbortTrans extends PEvent<Integer> {
        public eAbortTrans(int p) {
            this.payload = p;
        }
        private Integer payload;
        public Integer getPayload() {
    ...
    public static class eInformCoordinator extends PEvent<Long> {
        public eInformCoordinator(long p) {
            this.payload = p;
        }
    ...
    public static class eMonitor_AtomicityInitialize extends PEvent<Integer> {
        public eMonitor_AtomicityInitialize(int p) {
            this.payload = p;
        }
        private Integer payload;
        public Integer getPayload() {
    ...
    public static class eStartTimer extends PEvent<Void> {
        public eStartTimer() { }
        private Void payload;
        public Void getPayload() {
            return payload;
    ...
    public static class eCancelTimer extends PEvent<Void> {
        public eCancelTimer() { }
        private Void payload;
        public Void getPayload() {
            return payload;
    ...
    public static class eTimeOut extends PEvent<Void> {
        public eTimeOut() { }
        private Void payload;
        public Void getPayload() {
            return payload;
    ...
    public static class eDelayedTimeOut extends PEvent<Void> {
    ...
    public static class eDelayNodeFailure extends PEvent<Void> {
    ...
    public static class eShutDown extends PEvent<Long> {
        public eShutDown(long p) {
            this.payload = p;
        }
        private Long payload;
        public Long getPayload() {
    ...
    public static class AtomicityInvariant extends Monitor {
        ...
        public HashMap<Integer, HashMap<Integer, Integer>> get_participantsResponse() {
            return this.participantsResponse;
        };

        private int numParticipants = 0;
        public int get_numParticipants() {
        ...
        public AtomicityInvariant() {
            super();
            addState(State.keyedOn(States.INIT_STATE)
                    .isInitialState(true)
                    .withEvent(eMonitor_AtomicityInitialize.class, p -> {
                        Anon(p);
                        gotoState(States.WAITFOREVENTS_STATE);
                    }).build());
            addState(State.keyedOn(States.WAITFOREVENTS_STATE)
    ...
    public static class Progress extends Monitor {
        ...
        public int get_pendingTransactions() {
        ...
        public Progress() {
            ...
            addState(State.keyedOn(States.INIT_STATE)
                    .isInitialState(true)
                    .withEvent(eWriteTransReq.class, __ -> {
                        Anon_3();
                        gotoState(States.WAITFORRESPONSES_STATE);
                    }).build());
            addState(State.keyedOn(States.WAITFORRESPONSES_STATE)
                    .isInitialState(false)
                    .withEvent(eWriteTransResp.class, __ -> Anon_4())
                    .withEvent(eWriteTransReq.class, __ -> Anon_5())
                    .build());
            addState(State.keyedOn(States.ALLTRANSACTIONSFINISHED_STATE)
                    .isInitialState(false)
                    .withEvent(eWriteTransReq.class, __ -> {
                        Anon_6();
                        gotoState(States.WAITFORRESPONSES_STATE);
