...
public class PCoverGlobal implements Serializable {
    private static PCoverGlobal PCoverGlobal = null;                /** Singleton object of the class **/
    private static PCoverConfig config = null;                      /** Global configuration **/
    private static Scheduler scheduler = null;                      /** Scheduler **/
    @Getter @Setter private static String status = "incomplete";    /** Status of the run **/
    @Getter @Setter private static String result = "error";         /** Result of the run **/
