...
import pcover.values.exceptions.InvalidIndexException;
...
public class PSet extends PCollection {
   ...
   * @param val
   * @throws PCoverRuntimeException
   */
  public void setValue(int index, PValue<?> val) throws PCoverRuntimeException {
    throw new PCoverRuntimeException("Set value of a set is not allowed!");
  }
