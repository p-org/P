...
namespace P.Program
{
    ...
    {
        private class Events_505930799
        {
            public static PrtEventValue halt;
            public static PrtEventValue @null;
            public static PrtEventValue E1;
            static Events_505930799()
            {
                halt = new PrtEventValue(new PrtEvent("halt", Types_505930799.typeNull, 1, false));
                @null = new PrtEventValue(new PrtEvent("null", Types_505930799.typeNull, 1, false));
                E1 = new PrtEventValue(new PrtEvent("E1", Types_505930799.typeNull, 1, false));
            }
        }

        private class Types_505930799
        {
            ...
            static Types_505930799()
            {
                Types_505930799.typeNull = new PrtNullType();
                Types_505930799.typeNmdTupType_1 = new PrtNamedTupleType(new object[]{"_payload_1", Types_505930799.typeNull});
                Types_505930799.typeNmdTupType_2 = new PrtNamedTupleType(new object[]{"_payload_skip", Types_505930799.typeNull});
                Types_505930799.typeNmdTupType_3 = new PrtNamedTupleType(new object[]{"_payload_2", Types_505930799.typeNull});
                Types_505930799.typeNmdTupType_4 = new PrtNamedTupleType(new object[]{"_payload_0", Types_505930799.typeNull});
                Types_505930799.typeAny = new PrtAnyType();
                Types_505930799.typeInt = new PrtIntType();
                Types_505930799.typeEvent = new PrtEventType();
                Types_505930799.typeMachine = new PrtMachineType();
                Types_505930799.typeBool = new PrtBoolType();
            }
        }
        ...
        public static PrtImplMachine CreateMachine_Main(StateImpl application, PrtValue payload)
        {
            ...
            (((machine).self).permissions).Add(Events_505930799.E1);
            (((machine).self).permissions).Add(Events_505930799.halt);
            ((machine).sends).Add(Events_505930799.E1);
            ((machine).sends).Add(Events_505930799.halt);
        ...
        public class Main : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types_505930799.typeBool));
            }
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)(parent.self)).mach).PrtEnqueueEvent((PrtEventValue)(Events_505930799.E1), Events_505930799.@null, parent, (PrtMachineValue)(parent.self));
            ...
            public class AnonFun3_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (((PrtMachineValue)(parent.self)).mach).PrtEnqueueEvent((PrtEventValue)(Events_505930799.halt), Events_505930799.@null, parent, (PrtMachineValue)(parent.self));
                    (parent).PrtFunContSend(this, (currFun).locals, 1);
                    return;
                    AnonFun3_1:
                        ;
            ...
            static Main()
            {
                ...
                Main_Real1_Init = new Main_Real1_Init_Class("Main_Real1_Init", AnonFun2, AnonFun3, false, StateTemperature.Warm);
                Main_Real1_S1 = new Main_Real1_S1_Class("Main_Real1_S1", AnonFun1, AnonFun0, false, StateTemperature.Warm);
                PrtTransition transition_1 = new PrtTransition(AnonFun5, Main_Real1_S1, false);
                Main_Real1_Init.transitions.Add(Events_505930799.E1, transition_1);
            }
        }
    }
}
