...
namespace SimpleMachine
{
    public class Application : StateImpl
    {
        ...
        //TODO(expand: add static functions): 
-       //Each static function becomes a class and static field in Application class
        ...
        public class Main : PrtImplMachine
        {
            ...
            //Each function A in machine of type Foo becomes a class A_fun and a static field A
...
-           //and becomes a class "Anon_XX" and a static field AnonFunXX in the corresp. class Foo
            ...
            {
                //(outdated) Name property has been dropped
                public override string Name
                {
                    get
                    {
