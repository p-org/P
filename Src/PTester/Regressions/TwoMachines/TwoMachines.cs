...
namespace P.Program
{
    public class Application : StateImpl
    {
        ...
        static Application()
        {
            ...
            typeNmdTupType_2 = new PrtNamedTupleType(new object[]{"_payload_1", typeNull});
        ...
        public static PrtImplMachine CreateMachine_Main(StateImpl application, PrtValue payload)
        {
            ...
            (machine).currentTrigger = PrtValue.NullValue;
        ...
        public class Main : PrtImplMachine
        {
            ...
            public class AnonFun0_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    if (!!(Success).IsEqual(PrtValue.NullValue))
                        throw new PrtAssertFailureException("C:\\\\Users\\\\qadeer\\\\Work\\\\P\\\\Src\\\\PTester\\\\Regressions\\\\TwoMachines\\\\TwoMachines.p (55, 10): Raised event must be non-null");
            ...
            static Main()
            {
                ...
                Main_Init = new Main_Init_Class("Main_Init", AnonFun0, AnonFun2, false, StateTemperature.Hot);
            }
        }
