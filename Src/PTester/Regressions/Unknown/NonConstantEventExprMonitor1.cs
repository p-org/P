...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        ...
        {
            public static PrtEventValue E1;
            public static PrtEventValue E2;
            public static void Events_NonConstantEventExprMonitor1()
            {
                E1 = new PrtEventValue(new PrtEvent("E1", Types.type_0_298487115, 1, false));
                E2 = new PrtEventValue(new PrtEvent("E2", Types.type_5_298487115, 1, false));
            }
        }

        public partial class Types
        {
            public static PrtType type_0_298487115;
            public static PrtType type_1_298487115;
            public static PrtType type_2_298487115;
            public static PrtType type_3_298487115;
            public static PrtType type_4_298487115;
            public static PrtType type_5_298487115;
            static public void Types_NonConstantEventExprMonitor1()
            {
                Types.type_0_298487115 = new PrtNullType();
                Types.type_1_298487115 = new PrtAnyType();
                Types.type_2_298487115 = new PrtMachineType();
                Types.type_3_298487115 = new PrtEventType();
                Types.type_4_298487115 = new PrtIntType();
                Types.type_5_298487115 = new PrtBoolType();
            }
        }
        ...
        public static PrtImplMachine CreateMachine_Main(StateImpl application, PrtValue payload)
        {
            ...
            (((machine).self).permissions).Add(Events.E2);
            (((machine).self).permissions).Add(Events.E1);
            (((machine).self).permissions).Add(Events.halt);
            ((machine).sends).Add(Events.E1);
            ((machine).sends).Add(Events.halt);
            ((machine).sends).Add(Events.E2);
            (machine).currentPayload = payload;
            return machine;
        }

        public static PrtImplMachine CreateMachine_Real2(StateImpl application, PrtValue payload)
        {
            var machine = new Real2(application, PrtImplMachine.DefaultMaxBufferSize, false);
            (application).Trace("<CreateLog> Created Machine Real2-{0}", (machine).instanceNumber);
            (((machine).self).permissions).Add(Events.E1);
            (((machine).self).permissions).Add(Events.halt);
            (((machine).self).permissions).Add(Events.E2);
            ((machine).sends).Add(Events.E1);
        ...
        public static PrtSpecMachine CreateSpecMachine_M(StateImpl application)
        {
            ...
            ((machine).observes).Add(Events.E2);
            return machine;
        }
        ...
        public class Main : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_4_298487115));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_298487115));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_298487115));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_2_298487115));
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_298487115));
            }
            ...
            public class Action1_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    PrtFunStackFrame currFun = parent.PrtPopFunStackFrame();
                    PrtValue swap;
                    (parent).XYZ = (new PrtBoolValue(true)).Clone();
                    parent.PrtFunContReturn(null);
                }
            ...
            public class AnonFun4_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).mac = (application).CreateInterfaceOrMachine((parent).renamedName, "Real2", Events.@null);
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 1);
                    return;
                    AnonFun4_1:
                        ;
                    (parent).ev2 = (Events.E2).Clone();
                    (application).Announce((PrtEventValue)((parent).ev2), (parent).XYZ, parent);
                    (parent).ev1 = (Events.E1).Clone();
                    if (!!((parent).ev1).Equals(Events.@null))
                        throw new PrtAssertFailureException("C:\\\\Workspace\\\\P\\\\Tst\\\\RegressionTests\\\\Integration\\\\DynamicError\\\\SEM_TwoMachines_12\\\\NonConstantEventExprMonitor1.p (17, 4): Raised event must be non-null");
                    (application).Trace("<RaiseLog> Machine Main-{0} raised Event {1}", (parent).instanceNumber, (((PrtEventValue)((parent).ev1)).evt).name);
                    (parent).currentTrigger = (parent).ev1;
            ...
            public class AnonFun5_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).ev2 = (Events.E2).Clone();
                    (((PrtMachineValue)((parent).mac)).mach).PrtEnqueueEvent((PrtEventValue)((parent).ev2), (parent).XYZ, parent, (PrtMachineValue)((parent).mac));
            ...
            public class Main_Real1_S1_Class : PrtState
            {
                public Main_Real1_S1_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Main_Real1_S1_Class Main_Real1_S1;
            static Main()
            {
                Main_Real1_Init = new Main_Real1_Init_Class("Main_Real1_Init", AnonFun4, AnonFun5, true, StateTemperature.Warm);
                Main_Real1_S1 = new Main_Real1_S1_Class("Main_Real1_S1", AnonFun1, AnonFun0, false, StateTemperature.Warm);
                Main_Real1_Init.dos.Add(Events.E1, Action1);
                PrtTransition transition_1 = new PrtTransition(AnonFun6, Main_Real1_S1, false);
                Main_Real1_Init.transitions.Add(Events.@null, transition_1);
            }
        }

        public class Real2 : PrtImplMachine
        {
            public override PrtState StartState
            {
                get
                {
                    return Real2_Real2_Init;
                }
            }
            ...
            public Real2(StateImpl app, int maxB, bool assume): base (app, maxB, assume)
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_5_298487115));
            }
            ...
            public class Action2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    PrtFunStackFrame currFun = parent.PrtPopFunStackFrame();
                    PrtValue swap;
                    if (!((PrtBoolValue)(new PrtBoolValue(((currFun).locals[0]).Equals(new PrtBoolValue(false))))).bl)
                        throw new PrtAssertFailureException("C:\\\\Workspace\\\\P\\\\Tst\\\\RegressionTests\\\\Integration\\\\DynamicError\\\\SEM_TwoMachines_12\\\\NonConstantEventExprMonitor1.p (46, 3): Assert failed");
                    parent.PrtFunContReturn(null);
                }
            ...
            public class AnonFun3_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).PrtPushFunStackFrame(Action2, (Action2).CreateLocals((currFun).locals[0]));
                    AnonFun3_1:
                        ;
                    (Action2).Execute(application, parent);
            ...
            public static AnonFun3_Class AnonFun3 = new AnonFun3_Class();
            public class Real2_Real2_Init_Class : PrtState
            {
                public Real2_Real2_Init_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static Real2_Real2_Init_Class Real2_Real2_Init;
            static Real2()
            {
                Real2_Real2_Init = new Real2_Real2_Init_Class("Real2_Real2_Init", AnonFun1, AnonFun2, false, StateTemperature.Warm);
                Real2_Real2_Init.dos.Add(Events.E2, AnonFun3);
            }
        }
        ...
        public class M : PrtSpecMachine
        {
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    PrtFunStackFrame currFun = parent.PrtPopFunStackFrame();
                    PrtValue swap;
                    if (!((PrtBoolValue)(new PrtBoolValue(((currFun).locals[0]).Equals(new PrtBoolValue(true))))).bl)
                        throw new PrtAssertFailureException("C:\\\\Workspace\\\\P\\\\Tst\\\\RegressionTests\\\\Integration\\\\DynamicError\\\\SEM_TwoMachines_12\\\\NonConstantEventExprMonitor1.p (51, 30): Assert failed");
                    parent.PrtFunContReturn(null);
                }
            ...
            public static AnonFun2_Class AnonFun2 = new AnonFun2_Class();
            public class M_x_Class : PrtState
            {
                public M_x_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static M_x_Class M_x;
            static M()
            {
                M_x = new M_x_Class("M_x", AnonFun0, AnonFun1, false, StateTemperature.Warm);
                M_x.dos.Add(Events.E2, AnonFun2);
            }
        }
    }
}
