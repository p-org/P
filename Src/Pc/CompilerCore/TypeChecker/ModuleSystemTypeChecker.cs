...
namespace Plang.Compiler.TypeChecker
{
    public class ModuleSystemTypeChecker
    {
        ...
        {
            if (assertExpr.ModuleInfo != null) return;
        ...
        {
            if (bindExpr.ModuleInfo != null) return;
            ...
            // 2) Initialize Ip
            foreach (var binding in bindExpr.Bindings) currentModuleInfo.InterfaceDef.Add(binding.Item1, binding.Item2);
        ...
        {
            if (renameExpr.ModuleInfo != null) return;
        ...
        {
            if (composeExpr.ModuleInfo != null) return;

            //check that all component modules are wellformed
            foreach (var module in composeExpr.ComponentModules) CheckWellFormedness(module);
        ...
        {
            if (hideEExpr.ModuleInfo != null) return;
        ...
        {
            if (hideIExpr.ModuleInfo != null) return;
