...
- **Streamlit Web App** - Interactive web UI for design doc → P code
...
Create a `.env` file in the `Src/PeasyAI` directory:
...
PeasyAI will open in your default browser.
...
PeasyAI can be run as an MCP (Model Context Protocol) server, enabling AI-assisted P code generation directly within Cursor IDE.
...
```json
{
  "mcpServers": {
    "p-easyai": {
      ...
      "cwd": "/absolute/path/to/P/Src/PeasyAI",
      "env": {
