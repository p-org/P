...
extern "C"{
    ...
    */
    ...
    typedef void(PRT_CALL_CONV * PRT_LOG_FUN)(PRT_STEP step, PRT_MACHINEINST *context, PRT_MACHINEINST *sender, PRT_VALUE *eventid, PRT_VALUE *payload);
    ...
    * @param[in,out] machine The machine that is sending this message.
