...
extern const MIDL_SERVER_INFO PrtDistributed_ServerInfo;

extern const RPC_DISPATCH_TABLE PrtDistributed_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE PrtDistributed___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x6f15af3b,0x0784,0x4fe4,{0xa5,0x12,0x02,0xe9,0x00,0x6c,0xf6,0x60}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&PrtDistributed_v1_0_DispatchTable,
    0,
    0,
    0,
    &PrtDistributed_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE s_PrtDistributed_v1_0_s_ifspec = (RPC_IF_HANDLE)& PrtDistributed___RpcServerInterface;
...
static const MIDL_STUB_DESC PrtDistributed_StubDesc = 
    {
    (void *)& PrtDistributed___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION PrtDistributed_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE PrtDistributed_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)PrtDistributed_table
    };

static const SERVER_ROUTINE PrtDistributed_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)s_SendValue1,
    (SERVER_ROUTINE)s_SendValue2
    };

static const MIDL_SERVER_INFO PrtDistributed_ServerInfo = 
    {
    &PrtDistributed_StubDesc,
    PrtDistributed_ServerRoutineTable,
    PrtDistributed__MIDL_ProcFormatString.Format,
    PrtDistributed_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
