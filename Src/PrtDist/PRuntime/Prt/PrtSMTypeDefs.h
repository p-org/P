...
//
typedef VOID(PRT_ENTRYFUN)(__inout PRT_SMCONTEXT *context);


//
//Function type used by all state machines for exit functions                                                     
//
typedef VOID(PRT_EXITFUN)(__inout PRT_SMCONTEXT *context);

//
//Function type used by all state machines for exit functions                                                     
//
typedef VOID(PRT_ACTIONFUN)(__inout PRT_SMCONTEXT *context);