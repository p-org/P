...
/** A Union type to discriminate the Primitive value */
typedef struct PRT_PRIMVALUE_UNION {
...
typedef struct PRT_PRIMVALUE
{
	...
	PRT_PRIMVALUE_UNION *value;  /**< A primitive value is of PRT_PRIMVALUE_UNION type. */
} PRT_PRIMVALUE;
