...
void SeqAppendTest()
{
	...
	PRT_SEQVALUE *seq = (PRT_SEQVALUE *)PrtMkDefaultValue(iseqType);
...
void SeqNestedTest()
{
	...
	PRT_SEQVALUE *seq = (PRT_SEQVALUE *)PrtMkDefaultValue(aseqType);
...
void MapTest1()
{
	...
	PRT_MAPVALUE *a2aMap = (PRT_MAPVALUE *)PrtMkDefaultValue(any2anyType);
...
void BinaryBoolFunTest()
{
	...
	PRT_MAPVALUE *popFun = (PRT_MAPVALUE *)PrtMkDefaultValue(popFunType);
	for (funImg = 0; funImg < 16; ++funImg)
	{
		PRT_MAPVALUE *fun = (PRT_MAPVALUE *)PrtMkDefaultValue(binFunType);
	...
	PRT_MAPVALUE *revPopFun = (PRT_MAPVALUE *)PrtMkDefaultValue(popFunType);
	for (i = 1; i <= 16; ++i)
	{
