...
extern const MIDL_SERVER_INFO PrtRPC_ServerInfo;

extern const RPC_DISPATCH_TABLE PrtRPC_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE PrtRPC___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x1397cac6,0x51ca,0x4c50,{0x94,0x84,0x1a,0xfd,0x1c,0x35,0x3d,0x84}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&PrtRPC_v1_0_DispatchTable,
    0,
    0,
    0,
    &PrtRPC_ServerInfo,
...
RPC_IF_HANDLE s_PrtRPC_v1_0_s_ifspec = (RPC_IF_HANDLE)& PrtRPC___RpcServerInterface;
...
static const MIDL_STUB_DESC PrtRPC_StubDesc = 
    {
    (void *)& PrtRPC___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION PrtRPC_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE PrtRPC_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)PrtRPC_table
    };

static const SERVER_ROUTINE PrtRPC_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)s_SendValue1,
    (SERVER_ROUTINE)s_SendValue2,
    (SERVER_ROUTINE)s_SendValueMap1,
    (SERVER_ROUTINE)s_SendValueMap2
    };

static const MIDL_SERVER_INFO PrtRPC_ServerInfo = 
    {
    &PrtRPC_StubDesc,
    PrtRPC_ServerRoutineTable,
    PrtRPC_Types__MIDL_ProcFormatString.Format,
    PrtRPC_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
