...
module MULTIPAXOS
private update, chosen, goPropose, accepted, reject, agree, accept, prepare
sends SMR_SERVER_UPDATE, SMR_RM_OPERATION, STARTTIMER, CANCELTIMER
creates SMR_REPLICATED_MACHINE_IN, LeaderElection_Machine, Timer_Machine
{
	machine PaxosNode 
