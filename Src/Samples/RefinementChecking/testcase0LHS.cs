...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        ...
        static Application()
        {
            ...
            (isSafeMap).Add("HelperMachine", false);
            (isSafeMap).Add("ServerMachine", false);
            (renameMap).Add("Main", "TestDriver_Refinement");
            (renameMap).Add("HelperMachine", "HelperMachine");
            (renameMap).Add("ServerMachine", "ServerMachine");
