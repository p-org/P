...
namespace Main
{
    ...
    internal partial class Coordinator : PMachine
    {
        ...
        public void DoGlobalAbort()
        {
            ...
            TMP_tmp0_7 = (PEvent)(new eGlobalAbort(((PrtInt)0)));
        ...
        public async Task Anon_8()
        {
            ...
            if (TMP_tmp0_8)
            {
                ...
                if (TMP_tmp3_5)
                {
                    ...
                    TMP_tmp8_1 = (PEvent)(new eWriteTransSuccess(null));
                    currentMachine.SendEvent(TMP_tmp7_2, (Event)TMP_tmp8_1);
                    TMP_tmp9 = (PMachineValue)(((PMachineValue)((IPrtValue)timer_2)?.Clone()));
                    await GlobalFunctions.CancelTimer(TMP_tmp9, this);
        ...
        [IgnoreEvents(typeof(ePrepareSuccess), typeof(ePrepareFailed), typeof(eTimeOut))]
    ...
    internal partial class Participant : PMachine
    {
        ...
        public void Anon_15()
        {
            ...
            if (TMP_tmp2_10)
            {
                ...
                TMP_tmp4_7 = (PEvent)(new ePrepareSuccess(((PrtInt)0)));
                TMP_tmp5_5 = (PrtInt)(((PrtNamedTuple)pendingWrTrans_1)["transId"]);
                currentMachine.SendEvent(TMP_tmp3_9, (Event)TMP_tmp4_7, TMP_tmp5_5);
            }
            else
            {
                TMP_tmp6_5 = (PMachineValue)(((PMachineValue)((IPrtValue)coordinator_1)?.Clone()));
                TMP_tmp7_5 = (PEvent)(new ePrepareFailed(((PrtInt)0)));
                TMP_tmp8_3 = (PrtInt)(((PrtNamedTuple)pendingWrTrans_1)["transId"]);
                currentMachine.SendEvent(TMP_tmp6_5, (Event)TMP_tmp7_5, TMP_tmp8_3);
            }
        }
        [Start]
        [OnEntry(nameof(InitializeParametersFunction))]
    ...
    internal partial class Atomicity : PMonitor
    {
        ...
        public void Anon_17()
        {
            ...
            TMP_tmp0_14 = (PMachineValue)(((PrtNamedTuple)payload_3)["parcipant"]);
            TMP_tmp1_14 = (PrtBool)(((PrtBool)(receivedLocalCommits).ContainsKey(TMP_tmp0_14)));
            TMP_tmp2_11 = (PrtBool)(!(TMP_tmp1_14));
            currentMachine.Assert(TMP_tmp2_11,"");
            TMP_tmp3_10 = (PMachineValue)(((PrtNamedTuple)payload_3)["parcipant"]);
            TMP_tmp4_8 = (PrtInt)(((PrtNamedTuple)payload_3)["transId"]);
            ((PrtMap)receivedLocalCommits)[TMP_tmp3_10] = TMP_tmp4_8;
        }
        public void Anon_18()
        {
            Atomicity currentMachine = this;
            ...
            PrtMap TMP_tmp2_12 = new PrtMap();
            TMP_tmp0_15 = (PrtInt)(((PrtInt)(receivedLocalCommits).Count));
            TMP_tmp1_15 = (PrtBool)((PrtValues.SafeEquals(TMP_tmp0_15,numParticipants_1)));
            currentMachine.Assert(TMP_tmp1_15,"");
            TMP_tmp2_12 = (PrtMap)(new PrtMap());
            receivedLocalCommits = TMP_tmp2_12;
        }
        [Start]
        [OnEventGotoState(typeof(eMonitor_AtomicityInitialize), typeof(WaitForEvents), nameof(Anon_16))]
        class Init_3 : MonitorState
        {
        }
        [OnEventDoAction(typeof(eMonitor_LocalCommit), nameof(Anon_17))]
        [OnEventDoAction(typeof(eWriteTransSuccess), nameof(Anon_18))]
    ...
    internal partial class Main : PMachine
    {
        ...
        public void Anon_19()
        {
            ...
            TMP_tmp0_16 = (PrtInt)(((PrtInt)2));
            TMP_tmp1_16 = (PMachineValue)(currentMachine.CreateInterface<I_Coordinator>( currentMachine, TMP_tmp0_16));
            coord = (PMachineValue)TMP_tmp1_16;
            TMP_tmp2_13 = (PMachineValue)(((PMachineValue)((IPrtValue)coord)?.Clone()));
            currentMachine.CreateInterface<I_Client>(currentMachine, TMP_tmp2_13);
            TMP_tmp3_11 = (PMachineValue)(((PMachineValue)((IPrtValue)coord)?.Clone()));
            currentMachine.CreateInterface<I_Client>(currentMachine, TMP_tmp3_11);
        }
        [Start]
        [OnEntry(nameof(InitializeParametersFunction))]
    ...
    internal partial class Timer : PMachine
    {
        ...
        public void Anon_20()
        {
            ...
            PMachineValue payload_4 = (PMachineValue)(gotoPayload ?? ((PEvent)currentMachine.ReceivedEvent).Payload);
            this.gotoPayload = null;
            target = (PMachineValue)(((PMachineValue)((IPrtValue)payload_4)?.Clone()));
        ...
        public void Anon_21()
        {
            ...
            TMP_tmp0_17 = (PMachineValue)(((PMachineValue)((IPrtValue)target)?.Clone()));
            TMP_tmp1_17 = (PEvent)(new eCancelTimerFailed(null));
            currentMachine.SendEvent(TMP_tmp0_17, (Event)TMP_tmp1_17);
        }
        public void Anon_22()
        {
            Timer currentMachine = this;
            PrtInt payload_5 = (PrtInt)(gotoPayload ?? ((PEvent)currentMachine.ReceivedEvent).Payload);
            this.gotoPayload = null;
            PrtBool TMP_tmp0_18 = ((PrtBool)false);
            PMachineValue TMP_tmp1_18 = null;
            PEvent TMP_tmp2_14 = null;
            TMP_tmp0_18 = (PrtBool)(((PrtBool)currentMachine.Random()));
            if (TMP_tmp0_18)
            {
                TMP_tmp1_18 = (PMachineValue)(((PMachineValue)((IPrtValue)target)?.Clone()));
                TMP_tmp2_14 = (PEvent)(new eTimeOut(null));
                currentMachine.SendEvent(TMP_tmp1_18, (Event)TMP_tmp2_14);
                currentMachine.GotoState<Timer.WaitForStartTimer>();
                throw new PUnreachableCodeException();
            }
        }
        public void Anon_23()
        {
            ...
            TMP_tmp0_19 = (PrtBool)(((PrtBool)currentMachine.Random()));
            if (TMP_tmp0_19)
            {
                TMP_tmp1_19 = (PMachineValue)(((PMachineValue)((IPrtValue)target)?.Clone()));
                TMP_tmp2_15 = (PEvent)(new eCancelTimerFailed(null));
                currentMachine.SendEvent(TMP_tmp1_19, (Event)TMP_tmp2_15);
            }
            else
            {
                TMP_tmp3_12 = (PMachineValue)(((PMachineValue)((IPrtValue)target)?.Clone()));
                TMP_tmp4_9 = (PEvent)(new eCancelTimerSuccess(null));
                currentMachine.SendEvent(TMP_tmp3_12, (Event)TMP_tmp4_9);
            }
        }
        [Start]
        [OnEntry(nameof(InitializeParametersFunction))]
        ...
        [OnEventDoAction(typeof(eCancelTimer), nameof(Anon_21))]
        class WaitForStartTimer : MachineState
        {
        }
        [OnEntry(nameof(Anon_22))]
        [OnEventGotoState(typeof(eCancelTimer), typeof(WaitForStartTimer), nameof(Anon_23))]
