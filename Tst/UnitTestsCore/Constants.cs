...
namespace UnitTestsCore
{
    public static class Constants
    {
        ...
        public static bool ResetTests => bool.Parse(TestContext.Parameters["ResetTests"]);
        public static bool RunPc => bool.Parse(TestContext.Parameters["RunPc"]);
        public static bool RunPrt => bool.Parse(TestContext.Parameters["RunPrt"]);
        public static bool RunPt => bool.Parse(TestContext.Parameters["RunPt"]);
        public static bool RunZing => bool.Parse(TestContext.Parameters["RunZing"]);
        public static bool RunAll => bool.Parse(TestContext.Parameters["RunAll"]);
        public static bool PtWithPSharp => bool.Parse(TestContext.Parameters["PtWithPSharp"]);

        public static string TestResultsDirectory { get; } = Path.Combine(TestDirectory, $"TestResult_{Configuration}_{Platform}");
    }
}