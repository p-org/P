test tcOneNode [main = OneNode]:
  union ConsensusEPR, { OneNode };

test tcTwoNodes [main = TwoNodes]:
  union ConsensusEPR, { TwoNodes };

test tcThreeNodes [main = ThreeNodes]:
  union ConsensusEPR, { ThreeNodes };

test tcFourNodes [main = FourNodes]:
  union ConsensusEPR, { FourNodes };

test tcFiveNodes [main = FiveNodes]:
  union ConsensusEPR, { FiveNodes };

test tcTenNodes [main = TenNodes]:
  union ConsensusEPR, { TenNodes };