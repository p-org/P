...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        ...
        static Application()
        {
            ...
            (machineDefMap).Add("ServerClientInterface", "UNSOUNDAbstractServerMachine");
            (machineDefMap).Add("ClientInterface", "ClientMachine");
            (machineDefMap).Add("TestDriver0", "TestDriver0");
            (createMachineMap).Add("UNSOUNDAbstractServerMachine", CreateMachine_UNSOUNDAbstractServerMachine);
