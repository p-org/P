...
PRT_VALUE *P_FUN_BeginHeating_FOREIGN(PRT_MACHINEINST *context)
{
...
PRT_VALUE *P_FUN_DumpGrinds_FOREIGN(PRT_MACHINEINST *context)
{
...
PRT_VALUE *P_FUN_GrindBeans_FOREIGN(PRT_MACHINEINST *context)
{
...
PRT_VALUE *P_FUN_StartEspresso_FOREIGN(PRT_MACHINEINST *context)
{
    printf("P_FUN_StartEspresso_FOREIGN\n");
    return 0;
}

PRT_VALUE *P_FUN_StartSteamer_FOREIGN(PRT_MACHINEINST *context)
{
    printf("P_FUN_StartSteamer_FOREIGN\n");
    return 0;
}

PRT_VALUE *P_FUN_StopSteamer_FOREIGN(PRT_MACHINEINST *context)
{
