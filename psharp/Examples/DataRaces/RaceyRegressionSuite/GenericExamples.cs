...
namespace GenericExamples
{
    ...
    //    private void foo(Envelope envelope)
    //    {
    //        this.Send(this.Target, new eUnit(envelope));    // ERROR
    //    }
    ...
    //    private void foo()
    //    {
    //        this.Send(this.Target, new eUnit(this.Payload));

    //        this.Obj = this.Payload; // <---- TODO -- first argument should be THIS
    //    }
    //}
