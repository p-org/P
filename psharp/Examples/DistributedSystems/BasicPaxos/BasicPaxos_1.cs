...
//                this.Send(receivedMessage.Item1, new eReject(this.LastSeenProposal));
//            }
//            else
//            {
...
//                    this.LastSeenProposal, this.LastSeenProposalValue)));
...
//                Console.WriteLine("[Proposer-{0}] ProposeValuePhase1 (exit) ...", machine.Id);
...
//                    new Tuple<Proposal, int>(machine.NextProposal, machine.ProposeVal)));
...
//            var receivedMessage = (Tuple<Proposal, int>)this.Payload;
//            this.CountAgree++;

//            if (this.IsProposalLessThan(this.ReceivedAgree.Item1, receivedMessage.Item1))
//            {
//                this.ReceivedAgree = new Tuple<Proposal, int>(
//                    receivedMessage.Item1, receivedMessage.Item2);
//            }
