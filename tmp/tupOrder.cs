...
namespace P.Program
{
    ...
    public partial class Application : StateImpl
    {
        ...
        public class N : PrtImplMachine
        {
            ...
            {
                (fields).Add(PrtValue.PrtMkDefaultValue(Types.type_3_628838531));
            }
            ...
            public class AnonFun2_Class : PrtFun
            {
                ...
                public override void Execute(StateImpl application, PrtMachine _parent)
                {
                    ...
                    (parent).var_my_m = (application).CreateInterfaceOrMachine((parent).renamedName, "M", new PrtIntValue(3));
                    (parent).PrtFunContNewMachine(this, (currFun).locals, 1);
                    return;
                    AnonFun2_1:
                        ;
                    (parent).var_my_m = (application).CreateInterfaceOrMachine((parent).renamedName, "M", new PrtBoolValue(true));
            ...
            public class N_S_Class : PrtState
            {
                public N_S_Class(string name, PrtFun entryFun, PrtFun exitFun, bool hasNullTransition, StateTemperature temperature): base (name, entryFun, exitFun, hasNullTransition, temperature)
                {
                }
            }

            public static N_S_Class N_S;
            static N()
            {
                N_S = new N_S_Class("N_S", AnonFun2, AnonFun0, false, StateTemperature.Warm);
            }
        }
        ...
        public class M : PrtImplMachine
        {
            ...
            static M()
            {
                M_S = new M_S_Class("M_S", AnonFun1, AnonFun0, false, StateTemperature.Warm);
            }
        }
    }
}
